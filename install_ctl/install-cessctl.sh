...
##The public key of the wallet, obtained from the following website: https://polkadot.subscan.io/tools/ss58_transform
accountPublicKey=''
##Wallet public key
walletAddress=''
...
sudo sed -i "s|accountPublicKey : \"\"|accountPublicKey : \"${accountPublicKey}\"|g" ./cess_client.yaml
